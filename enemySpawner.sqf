...
private _pickedFaction = (_factionPool select (floor(random count _factionPool)));
...
for [{private _i = 0}, {_i < _amountToSpawn}, {_i = _i + 1}] do {
	private _newUnit = _newGroup createUnit ["I_C_Soldier_Bandit_7_F", _spawnPos, [], 0, "CAN_COLLIDE"];
